  ...
  <div class="collapse navbar-collapse" id="myNavbar">
    <ul class="nav navbar-nav">
	  ...
	  <li class="dropdown">
       ...
       <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
        Imágenes<span class="caret"></span>
        </a>
		<ul class="dropdown-menu">
		  <li><a href="<?=base_url()?>imagen/crear">Crear</a></li>
		  <li><a href="<?=base_url()?>imagen/listar">Listar</a></li>
		  <li><a href="<?=base_url()?>imagen/borrar">Borrar</a></li>
	     </ul>
      </li>
    </ul>
   --> 
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg pull-right">
                                <div class="listview" id="notifications">
                                    ...
                                    <div class="lv-body">
                                        <a class="lv-item" href="http://www.google.es">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img-sm" src="img/profile-pics/1.jpg" alt="">
                                                </div>
        ...
        <section id="main" data-layout="layout-1">
            <aside id="sidebar" class="sidebar c-overflow">
                ...
                <ul class="main-menu">
                    ...
                    <li class="sub-menu">
                        <a href=""><i class="zmdi zmdi-sort-asc"></i> Diseño</a>
