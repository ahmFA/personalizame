                    ...
                    <tr>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h5 class="media-heading"><a href="#">  <?= $producto['articulo']['nombre'] ?> - <?= $producto['color'] ?> - <?= $producto['talla'] ?></a></h5>
                             <!--    <h5 class="media-heading"> by <a href="#">Brand name</a></h5>  -->
                                <span>Status: </span><span class="text-success"><strong>En Stock</strong></span>
                            </div>
                        </div></td>
                        <td class="col-sm-1 col-md-1" style="text-align: center">
                        <input type="text" class="form-control" id="exampleInputEmail1" readonly="readonly" value="<?= $producto['cantidad'] ?>">
                        </td>
