...
<div class="container">
	...
	<div class="form-group col-xs-4">	
		...
		<input class="form-control" id="idNombre" type="text" name="nombre" maxlength="2" required="required" placeholder="completa este campo" title="El Tamaño debe contener 2 dígitos" value="<?= $body['tamano']->nombre ?>"> <br/>
	</div>
					...
					<div class="cp-container">
						<div class="form-group fg-line" id="nombre-form">
							<label for="nombre">Nombre</label> <input type="text"
								...
								maxlength="2" required="required" placeholder="completa este campo" title="El Tamaño debe contener 2 dígitos"
								value="<?=$body['tamano']->nombre; ?>">
						</div>
					</div>
				</div>
			</div>
